...
> Обзор операционки парсинга — в [PARSING.md](../market/PARSING.md).
> План верхнего уровня (магазины, аффилиаты) — в [SHOPS_PARSING.md](../market/SHOPS_PARSING.md).
...
- [PARSING.md](../market/PARSING.md) — текущая операционка
- [SHOPS_PARSING.md](../market/SHOPS_PARSING.md) — план магазинов
- [OFFERS_UX.md](../market/OFFERS_UX.md) — UI карусели/Hot Stock
- [artist_page_and_filters.md](../search/artist_page_and_filters.md) — классификация типа релиза, ради которой нужны полные описания
