...
> Трекинг переходов и воронка в Яндекс.Метрике вынесены в отдельный спек:
> [CLICK_REDIRECTOR_AND_METRIKA.md](CLICK_REDIRECTOR_AND_METRIKA.md).
> Там же — почему JS-редирект теряет клики и как это обходится 302-редиректором.
