    ...
    async with async_session_maker() as db:
        rows = (await db.execute(
            text(
                ...
                # source='discogs' — единственный платный канал: его картинки
                # тратят дневной бюджет Discogs, зарезервированный под живых
                # юзеров. Мастера с бесплатным источником закроют ту же сетку
                # артиста, только даром.
                "  AND source IS DISTINCT FROM 'discogs' "
