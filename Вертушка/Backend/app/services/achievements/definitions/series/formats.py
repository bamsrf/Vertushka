...
DEFINITIONS: list[AchievementDefinition] = [
    ...
    _fmt(
        ...
        done="Ты вышел за пределы винила.",
    ),
    _fmt(
        ...
        done="Три носителя на одной полке.",
    ),
    _fmt(
        ...
        done="Все четыре носителя собраны.",
    ),
    _fmt(
        ...
        done="Ни одного предрассудка не осталось.",
    ),
    # --- Кассеты ------------------------------------------------------------
    _fmt(
    ...
    _fmt(
        ...
        done="Двести пятьдесят компактов.",
    ),
    # --- Бокс-сеты ----------------------------------------------------------
    _fmt(
