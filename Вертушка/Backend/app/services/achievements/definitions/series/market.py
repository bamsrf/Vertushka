...
DEFINITIONS: list[AchievementDefinition] = [
    ...
    _d(M4_CODE, "Цена-огонь", "Найди предложение дешевле оценки Discogs.",
       ...
       done="Цена оказалась ниже рынка."),
