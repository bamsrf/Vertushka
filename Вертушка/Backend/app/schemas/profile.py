...
class ProfileShareSettings(BaseModel):
    ...
    # Когда ссылкой на профиль реально поделились. Клиент читает это поле,
    # чтобы шаг чеклиста «Поделиться профилем» не открывался заново после
    # переустановки: локальный флаг живёт в AsyncStorage одного устройства.
