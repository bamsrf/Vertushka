...
export const RECORD_TOUR_STEPS: RecordTourStep[] = [
  ...
  },
  {
    key: 'offers',
    title: 'Где купить',
    body: 'Живые предложения магазинов: наличие и цена на эту минуту. Нажми на магазин — откроется его страница.',
    icon: 'business-outline',
  },
  {
    key: 'history',
    title: 'Как менялась цена',
    body: 'График показывает, дорожала пластинка или дешевела, и отмечает исторический минимум — с ним удобно сравнивать текущую цену.',
