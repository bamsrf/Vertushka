...
export const COACH_MARKS: CoachMarkMeta[] = [
  {
    ...
    body: 'Сверху выбираешь: сканировать штрихкод или сфотографировать обложку. Если пластинки нет ни в Discogs, ни в Маркете, добавь её вручную кружком справа внизу.',
    unlock: 'первый заход на экран сканирования',
    where: 'Сканер → переключатель сверху, ручной ввод в кружке справа внизу',
    goTo: { route: '/(tabs)' },
    icon: 'plus',
  },
  {
    ...
    body: 'Сожми сетку двумя пальцами: останутся одни обложки, и влезет вся полка. Разожми, чтобы вернуть подписи.',
  ...
  },
  {
    ...
    body: 'Раскладывай как удобно тебе: жанры, эпохи, «на продажу». Пластинка может лежать сразу в нескольких папках.',
  ...
  },
  {
    ...
    body: 'Задержи палец на обложке, чтобы включить выбор. Дальше папки, удаление и подарки сразу для нескольких.',
  ...
  // а «другие версии» хотя бы честно подписаны кнопкой.
  {
    ...
    body: 'Коллекционка — дорогая пластинка, за которой охотятся: желающих на Discogs заметно больше, чем владельцев. Лимитка — специальное издание. Популярно значит, что на неё высокий спрос прямо сейчас.',
  ...
  },
  {
    ...
    priority: 26,
    title: 'Цвет винила',
    body: 'Один и тот же альбом печатают на чёрном, цветном и прозрачном виниле. Цвет относится к конкретному изданию и заметно влияет на цену.',
  ...
  },
  {
    ...
    priority: 38,
    title: 'Цена магазина',
    body: 'Это реальный ценник конкретного магазина сейчас, а не оценка Discogs выше. Поэтому числа отличаются: одно показывает, сколько просят, другое — сколько такие пластинки обычно стоят.',
  ...
  },
  {
    ...
    priority: 44,
    title: 'Другие версии',
    body: 'Один альбом переиздают десятки раз: разные годы, страны, цвет винила. Здесь собраны все издания этого релиза. Сравни и добавь именно своё.',
  ...
  },
  {
    ...
    body: 'Скинь друзьям ссылку на профиль, и они забронируют пластинку из вишлиста. Что именно выбрали, ты не узнаешь: сюрприз остаётся сюрпризом.',
