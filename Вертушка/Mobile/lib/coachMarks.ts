...
export const COACH_MARKS: CoachMarkMeta[] = [
  ...
  // а «другие версии» хотя бы честно подписаны кнопкой.
  {
    ...
    body: 'Коллекционка стоит дороже $100 и почти не появляется в продаже. Лимитка — специальное издание. Популярно значит, что на неё высокий спрос на Discogs прямо сейчас.',
